	...
	$(document)
			.ready(
					function() {
						...
						$("#editBtn")
								.click(
										function() { //확인 클릭 시***회원정보 수정 페이지로 이동**비번일치여부 확인***
											console.log("확인버튼 클릭");
											if (choose == "edit") {
...
<body>
	...
	<section class="job-single-content section-padding">
		...
		<div class="container">
			<button type="button"
				class="tab-item genric-btn primary-border e-large" id="edit"
				autofocus>회원정보수정</button>
			<button type="button"
				class="tab-item genric-btn primary-border e-large" id="change">비밀번호
				변경</button>
			<div class="row">
				<div class="col-lg-8">
								...
								<div class="job-text">
									...
									<div id="changeForm" class="hide jobs-title">
										<ul class="jobs-title">
											...
											<li class="tooltip">안전한 비밀번호 설정 <span
												class="tooltiptext">안전한 비밀번호 작성법 비밀번호 작성시 타인 또는 컴퓨터
													프로그램을 이용하여 쉽게 비밀번호를 알아 낼 수 없도록 숫자, 영문자, 특수문자 조합을 권장 합니다.</span>
											</li>
										</ul>
										<table class="find-form jobs-title jobs-title">
											<tr>
												...
												<td><input type="password" name="nowPw" id="nowPw"
													maxlength="20" placeholder="현재 비밀번호"> <span
													id="nwpwCmt"></span></td>
											<tr>
												<th>새 비밀번호</th>
												<td><input type="password" name="newPw" id="newPw"
													maxlength="20" placeholder="새 비밀번호"> <span
													id="pwCmt"></span></td>
											</tr>
											<tr>
												<th>새 비밀번호 확인</th>
												<td><input type="password" name="newPwChk"
													id="newPwChk" maxlength="20" placeholder="새 비밀번호 확인">
													<span id="pwChkCmt"></span></td>
											</tr>
										</table>
										<div class="btnGroup jobs-title">
											<button type="button" class="genric-btn success radius"
												id="changeBtn" onclick="changePw()">수정완료</button>
										</div>
									</div>
								</div>
							</div>
