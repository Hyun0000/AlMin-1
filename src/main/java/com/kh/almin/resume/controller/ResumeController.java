...
// ===================================================================	
	@GetMapping(value = "/allresAjax/{userid}", produces="text/plain;charset=UTF-8") //로그인된 회원 전체 이력서 조회
	@ResponseBody
	public String goAllResumePageAjax(@PathVariable(value = "userid") String userId) {
		System.out.println("goAllResumePageAjax 진입");
		System.out.println("userId : " + userId);
